export default {
  ...
  cases: {
    ...
    list: [
      ...
      { title: 'W3c.Group', filename: 'w3c-group', img: 'w3c-group.png', date: '2020/05/01', info: 'W3C (Web3.0 Content Group) creator community is a content platform that gathers various topics in the form of a group. It is a whole composed of multiple groups. The direction of the effort is to use the characteristics of the blockchain to promote collaboration between group members. <a href="/cases/w3c-group">more.</a>' },
      { title: 'Ocean ONE', filename: 'ocean-one', img: 'ocean-one.png', date: '2020/05/02', info: 'Ocean ONE is a new generation of decentralized exchange based on the Mixin Network, which is the first decentralized exchange for having the same experience as centralized exchange. <a href="/cases/ocean-one">more.</a>' },
      { title: 'Web Multi-currenty Wallet', filename: 'wallet-web', img: 'wallet-web.png', date: '2020/05/04', info: 'Based on the standard REST API, provided by Mixin, it is easy for developers to integrate Mixin\'s full cryptocurrency wallet and be compatible with each previous version. This demo fully realizes all the functions of a Web version of the full cryptocurrency wallet ...<a href="/cases/wallet-web">more.</a>' },
      { title: 'Flowin: A C2C Shopping Platform', filename: 'flowin', img: 'flowin.png', date: '2020/05/12', info: 'Based on Mixin Network, people can exchange anything in Flowin using digital assets. <a href="/cases/flowin">more.</a>' },
      { title: 'OhMy.Xin: Hosting Mixin Bots for you', filename: 'ohmy', img: 'ohmy.png', date: '2020/05/13', info: 'OhMy.Xin is a SaaS platform for hosting Mixin Bots based in Mixin Messenger. On OhMy.Xin platform, users can easily put a Mixin Bot, which is unified but powerfully functional, online. <a href="/cases/ohmy">more.</a>' },
    ]
  },

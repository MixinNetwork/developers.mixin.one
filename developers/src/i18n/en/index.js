export default {
  ...
  secret: {
    ...
    key_content_upgrade: 'Upgrade current key of this app to latest solution, the original pin and pin_token can still be used for old system wallet transfers. You need to use the new session id and session private key to send messages. Note that this operation is irreversible!',
    key_content_reset: 'Generate a new set of keys for the current app, including Session ID, Session Private Key and Server Public Key. Note that the Spend Private Key will not be reset, please keep it safe!',
    key_btn_upgrade: 'Upgrade Key',
    key_btn_generate: 'Generate a new key',
    key_question_new: 'Do you want to generate keys?',
    key_question_upgrade: 'Do you want to upgrade keys?',
    key_question_reset: 'Do you want to reset session?',

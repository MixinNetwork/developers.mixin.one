export default {
  ...
  home: {
    ...
    nextstep: {
      title: "Next Step",
      left: [{ info: "Start your next project, explore interactive turorials, and manage your account.", button: "Go to dashboard", href: "#" }],
      right: [
  ...
  information: {
    ...
    resource_patterns_desc: "Resource patterns for your app, split by line and max 10 items. e.g.: \n" + "https://mixin.one/codes/c78233a1-ffa6-453e-8bb3-6282a76bba78 \n" + "https://mixin.one/codes",
    immersive: "Immersive",
  ...
  secret: {
    ...
    session_content:
      "Generate new session key for this App. It can be used to request user information, send messages, etc to Mixin Messenger API. It can be regenerated on demand.<br /><br /> server_public_key: hex ed25519 public key <br /> session_private_key: hex ed25519 seed",
    session_btn: "Generate a new key",
    session_question: "Do you want to generate a new key?",
    key_title: "WALLET",
    key_content:
      'Generate spend private key for this App. It can be used to receive, send or withdraw wallet assets. <span class="warning">It cannot be reproduced afterwards, please keep it safely.</span>',
  ...
  billing: {
    ...
    cc_content:
      "Credit is the amount of money you have deposited to the app. Cost is the amount of money you have spent on the app.  <br /><br /> Users: the cost of all app users. <br /><br /> Resources: the cost of all deposits <br /><br /> Notice: The credit will be updated after seconds when you deposit.  ",
    credit: "Credit",
    cost: "Cost",
    users: "Users:",
    resources: "Resources:",
    ...
    pay_btn: "Deposit",
    subuser_count: "Subuser count",
    address_count: "Address count",
    deposit_count: "Deposit count",
    service_charge: "Service Charge",
    service: "Service",
    create_subuser: "Create Subuser",
    create_ethereum_address: "Create Ethereum Address",
    create_polygon_address: "Create Polygon Address",
    bitcoin_deposit: "Bitcoin Deposit",
    deposit_desc: "Please enter the amount you want to deposit",

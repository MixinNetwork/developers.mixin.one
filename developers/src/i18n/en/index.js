export default {
  ...
  home: {
    ...
    menus: ['Latest News', 'Use Cases', 'Documentation', 'Dashboard'],
    main: {
      title: 'Build decentralized applications on Mixin',
      info: [
        '<b>Fast&nbsp;-&nbsp;</b>More than 1,000,000 TPS with final confirmation in under 1 second.',
        '<b>Developer Friendly&nbsp;-&nbsp;</b>A standard REST API that works with any language.',
        '<b>Powerful&nbsp;-&nbsp;</b>Supports 28 blockchains, including BTC, ETH, and XMR.',
        '<b>Secure&nbsp;-&nbsp;</b>All assets are stored on a distributed PoS-BFT-DAG network.',
        '<b>Free&nbsp;-&nbsp;</b>No transaction fee.',
        '<b>Privacy&nbsp;-&nbsp;</b>End-to-end encrypted messages.',
        '<b>Multisig&nbsp;-&nbsp;</b>Safer management of large assets.',
        '<b>User Friendly&nbsp;-&nbsp;</b>Protected by a 6-digit D3M-PIN.',
      ],
    ...
    documentation: {
      ...
      left: [
        {
          ...
          info: 'F1EX is a standalone exchange product by Fox.ONE, with low token-issuance costs, high performance, a rich management dashboard, multi-chain support, and a great ecosystem.',
          button: 'Quick Start',
          href: '#',
        },
        {
      ...
      right: [
        { title: 'QUICKSTART', info: 'How does it work?', href: '#' },
        { title: 'TUTORIALS', info: 'Walkthroughs of common tasks', href: '#' },
    ...
    nextstep: {
      title: 'Next Step',
      left: [
        { info: 'Start your next project, explore interactive tutorials, and manage your account.', button: 'Go to Dashboard', href: '#' },
      ],
      right: [
        { title: 'QUICKSTART', info: 'Need help getting started?', href: '#' },
        { title: 'TUTORIALS', info: 'Want to join the developer group?', href: '#' },
      ],
    },
    footer: {
      community: {
  ...
  news: {
    ...
    list: [
      {
        title: 'Mixin Messenger bots now return currency and locale', filename: 'messenger-currency-and-locale', info: '', date: '2020/04/29', img: '',
      },
      {
        title: 'Mixin Messenger supports pinning bots to the home page', filename: 'messenger-bottom-navigation', info: '', date: '2020/04/27', img: '',
      },
      {
        title: 'Blockchair now supports the Mixin Network explorer', filename: 'network-explorer-blockchair', info: '', date: '2020/04/21', img: '',
      },
      {
        title: 'Mixin supports the DGD dissolution plan', filename: 'dgd-dissolution', info: '', date: '2020/03/31', img: '',
      },
      {
      ...
      {
        title: 'Support for the Handshake public chain', filename: 'blockchain-handshake', info: '', date: '2020/03/23', img: '',
      },
      {
        title: 'Support for the Nervos public chain', filename: 'blockchain-nervos', info: '', date: '2020/03/19', img: '',
      },
      {
        title: 'Support for the VCash public chain', filename: 'blockchain-vcash', info: '', date: '2020/02/02', img: '',
      },
      {
        title: 'Support for the Grin public chain', filename: 'blockchain-grin', info: '', date: '2020/01/27', img: '',
      },
      {
        title: 'Support for the Ravencoin public chain', filename: 'blockchain-ravencoin', info: '', date: '2020/01/06', img: '',
      },
      {
    ...
    desc_list: [
      '<p>Mixin cannot succeed without developers, which is why we prepared 10,000 XIN as a developer incentive for 2018.</p><p>Developers can always help Mixin by contributing code or documentation to any repository on our GitHub: https://github.com/MixinNetwork.</p><p>In the future, besides these regular contributions, we will announce more developer events here with XIN rewards.</p><p>Before this announcement, many developers had already been working on Mixin. We will distribute about 50 XIN to recognize their contributions.</p>',
    ],
  },
  ...
  cases: {
    ...
    list: [
      ...
      {
        title: 'Web Multi-currency Wallet',
        filename: 'wallet-web',
        img: 'wallet-web.png',
        date: '2020/05/04',
    ...
    },
    {
      ...
      child: [
        { name: 'Overview', path: 'wallet/overview', router: 'wallet/overview' },
        {
          name: 'Tutorials',
          child: [
            { name: 'Creating Mixin Wallet', path: 'wallet/getting-started/create-app', router: 'wallet/getting-started/create-app' },
  ...
  dashboard: {
    ...
    buy: {
      title: 'Buy Apps',
      desc1: 'You do not have enough app quota. Please buy more first.',
      desc2: 'Note: please create your apps as soon as you complete payment, because prices may change frequently.',
      btn: 'Buy {count} App',
      btns: 'Buy {count} Apps',
    },
  },
  information: {
    ...
    encrypted_confirm:
    'Please make sure you have upgraded your bot code to support encrypted messages. This operation cannot be reverted once it is enabled.',
    errors: {
  ...
  wallet: {
    ...
    des_2: 'Open Mixin Messenger > search for {app_number} > find this app > deposit by transfer.',
    amount: 'Amount',
    mixin_id_placeholder: '',
    pin: '',
    pin_label: 'PIN',
    opponent: 'Mixin ID / Mainnet Address',
    ...
    secret_intro: 'Used only for signing. It will not be sent to any server.',
  ...
  secret: {
    ...
    secret_content: 'OAuth Client Secret is required to generate an OAuth signature and obtain a user\'s private information.',
    secret_btn: 'Generate a new secret',
    secret_question: 'Do you want to reset the secret?',
    session_title: 'App Session',
    session_content: 'Generate a new session key for this app. It can be used to request user information, send messages, and more through the Mixin Messenger API. It can be regenerated at any time.<br /><br /> server_public_key: hex ed25519 public key <br /> session_private_key: hex ed25519 seed',
    session_btn: 'Generate a new key',
    session_question: 'Do you want to generate a new key?',
    key_title: 'WALLET',
    key_content: 'Generate a spend private key for this app. It can be used to receive, send, or withdraw wallet assets. <span class="warning">It cannot be reproduced later, so please keep it safe.</span>',
    key_registered_content: 'This app has already been registered. <span class="warning">The Spend Key cannot be reproduced later, so please keep it safe.</span>',
    key_btn: 'Register Wallet',
    key_question: 'Do you want to register the wallet?',
    key_confirm: 'I confirm that I have saved the Spend Private Key safely.',
    qrcode_title: 'Code URL',
    qrcode_content: 'Display or rotate the code_url for this app.',
    qrcode_btn1: 'Show',
    qrcode_btn2: 'Rotate',
    rotate_qrcode_question: 'Do you want to reset the code_url?',
    des: 'Neither the Mixin server nor the browser stores this information. If you lose it, you can generate a new one.',
  },
  billing: {
    title: 'Billing',
    cc_title: 'App Credit & Cost',
    cc_content: 'Credit is the amount of money you have deposited into the app. Cost is the amount of money you have spent on the app.<br /><br /> Users: the total cost of all app users.<br /><br /> Resources: the total cost of all deposits.<br /><br /> Notice: credit is updated a few seconds after you make a deposit.',
    credit: 'Credit',
    cost: 'Cost',
    users: 'Users:',
    resources: 'Resources:',
  ...
  message: {
    ...
    errors: {
      ...
      mixin_id: 'Please enter a valid Mixin ID or mainnet address.',
      copy: 'Copy failed.',
      reset: 'Resetting, please wait...',
      overtime: 'Request failed. Please check the network.',
      unknown: 'Unknown error.',
      download: 'Please download this in a browser.'
    },
    app: {
      secret_tips: 'Please generate this on your computer.',
    },
  },
};

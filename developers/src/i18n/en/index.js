export default {
  ...
  news: {
    ...
    route: "Mixin News",
    list: [
      { title: 'All BCH Backers Are Dumbass', date: 'Mar 14, 2020', href: '', filename: 'developer_incentive', info: 'What’s Bitcoin Cash?<br />It’s a Bitcoin Core software fork without any technical improvements, but three declines:' },
      { title: 'Developer Incentive', date: 'Dec 10, 2019', href: '', filename: 'developer_incentive', info: 'Mixin is impossible to succeed without developers, that’s why we would prepare 10,000 XIN as the developer incentive for year 2018.Developers can always help Mixin by contribute code or documentation to any ...' },
      { title: 'Ubuntu WireGuard Setup', date: 'Oct 25, 2019', href: '', filename: 'developer_incentive', info: 'Now I use WireGuard to protect my network connection, both the server and client are running Ubuntu.Install and generate a pair of keys on both machines in the same way.' },
      { title: 'Those Lost Years', date: 'Oct 15, 2019', href: '', filename: 'developer_incentive', info: '5 years since my last blog post, what if I have kept blogging, it would be a great treasure for me to discover my mind in that period. There are some significant changes inside me, and an obvious one is ...' },
      { title: 'Google Cloud Storage Images Processing', date: 'Oct 08, 2014', href: '', filename: 'developer_incentive', info: 'There are plenty of images processing work in Shou.TV, especially the snapshots of video streams. Instead of building our own distributed image service, we plan to use Google App Engine, as we ...' },
      { title: 'Node.js Zero Downtime Process Manager an...', date: 'Sep 07, 2014', href: '', filename: 'developer_incentive', info: 'As an experienced Rails developer, I have been familiar with plenty of zero downtime rack servers, they are quite easy to deploy and can achieve zero downtime between each new deployment and balanc...' },
      { title: 'Ubuntu WireGuard Setup', date: 'Oct 25, 2019', href: '', filename: 'developer_incentive', info: 'Now I use WireGuard to protect my network connection, both the server and client are running Ubuntu.Install and generate a pair of keys on both machines in the same way.' },
      { title: 'Those Lost Years', date: 'Oct 15, 2019', href: '', filename: 'developer_incentive', info: '5 years since my last blog post, what if I have kept blogging, it would be a great treasure for me to discover my mind in that period. There are some significant changes inside me, and an obvious one is ...' },
      { title: 'Google Cloud Storage Images Processing', date: 'Oct 08, 2014', href: '', filename: 'developer_incentive', info: 'There are plenty of images processing work in Shou.TV, especially the snapshots of video streams. Instead of building our own distributed image service, we plan to use Google App Engine, as we ...' },
      { title: 'Node.js Zero Downtime Process Manager an...', date: 'Sep 07, 2014', href: '', filename: 'developer_incentive', info: 'As an experienced Rails developer, I have been familiar with plenty of zero downtime rack servers, they are quite easy to deploy and can achieve zero downtime between each new deployment and balanc...' },

export default {
  ...
  secret: {
    ...
    key_content_upgrade: '将当前应用的密钥升级至最新方案，旧的 pin、pin_token 和 private_key 仍可用于旧系统钱包转账，发消息需要使用新的 session id，注意此过程不可逆！',
    key_content_reset: '为当前应用生成一组新的密钥，包括 Session ID, Session Private Key 和 Server Public Key。注意 Spend Private Key 不会重置，请妥善保管！',

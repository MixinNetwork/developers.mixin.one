export default {
  ...
  secret: {
    ...
    key_title: '应用密钥',
    key_content_new: '为当前应用生成一组新的密钥，包括 Session ID, Session Private Key，Server Public Key 和 Spend Private Key。',
    key_content_upgrade: '将当前应用的密钥升级至最新方案，旧的 pin、pin_token 和 private_key 仍可用于旧系统钱包转账，发消息需要使用新的 session id，<span class="warning">注意此过程不可逆！</span>',
    key_content_reset: '为当前应用生成一组新的密钥，包括 Session ID, Session Private Key 和 Server Public Key。<span class="warning">注意 Spend Private Key 不会重置，请妥善保管！</span>',
    key_btn_upgrade: '升级密钥',
    key_btn_generate: '生成新的密钥',
    key_question_new: '确认生成密钥？',
    key_question_upgrade: '确认升级密钥？',
    key_question_reset: '确认重置密钥？',

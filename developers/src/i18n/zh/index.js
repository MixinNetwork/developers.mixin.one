export default {
  ...
  home: {
    ...
    nextstep: {
      title: "下一步",
      left: [{ info: "开始您的下一个项目，探索交互式教程，并管理您的帐户。", button: "前往开发者后台", href: "#" }],
      right: [
  ...
  secret: {
    ...
    session_title: "会话密钥",
    session_content:
      "为当前应用生成会话密钥，该密钥用于访问 Mixin Messenger API，可以请求用户信息、给用户发消息等功能，按需可重新生成。<br /> server_public_key: hex ed25519 public <br /> session_private_key: hex ed25519 seed",
    session_btn: "生成新的密钥",
    session_question: "确认生成密钥？",
    key_title: "应用钱包",
    key_content: '为当前应用生成钱包密钥，该密钥用于接收、转账和提现钱包资产。<span class="warning">生成后无法重置，请妥善保管。</span>',
    key_registered_content: '当前应用已注册了钱包，<span class="warning">请保持 Spend Key 安全，丢失无法重置！</span>',
    key_btn: "注册钱包",
    key_question: "确认注册？",
  ...
  billing: {
    ...
    cc_title: "充值和花费统计",
    cc_content:
      "充值跟消费只针对这个机器人，充值是机器人的充值总金额。花费分为两部分，分别是资源(目前主要是链上充值)和子用户创建 <br /><br /> 子帐号：该应用下所有的子帐号花费 <br /><br /> 资源：该应用下所有的充值花费 <br /><br /> 注意：充值后会过几秒钟到帐",
    credit: "充值总计",
    cost: "花费总计",
    users: "子帐号花费:",
    resources: "资源花费:",
    ...
    service_charge: "服务费",
    service: "服务",
    create_subuser: "创建子帐号",
    create_ethereum_address: "创建 Ethereum 地址",
    create_polygon_address: "创建 Polygon 地址",
    bitcoin_deposit: "充值 Bitcoin",
    deposit_desc: "请输入您要充值的金额",
    enter_amount: "输入金额",
  },
  button: {
    save: "保存",

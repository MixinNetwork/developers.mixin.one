export default {
  ...
  cases: {
    ...
    list: [
      ...
      { title: '公平可验证骰子游戏 - DICEOS', filename: 'diceos', img: 'diceos.png', date: '2020/5/27', info: 'Diceos 骰子游戏基于 Mixin 开发，现支持 BTC、EOS、BOX、XIN、ETH、DOGE 下注，界面美观、交互体验友好，游戏公平可验证，玩的用户很多。<a  href="/cases/diceos">更多内容</a>' },

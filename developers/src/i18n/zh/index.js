export default {
  ...
  cases: {
    ...
    list: [
      ...
      { title: '比特币奖励平台 - 水龙头', filename: 'exin-earn', img: 'exin-local.png', date: '2020/5/18', info: '水龙头 App 是第一个通过网购就能轻松获得比特币奖励的平台，目前已经接入淘宝、天猫、京东、拼多多、饿了么等电商平台，通过水龙头完成网购就能获得来自相应的电商平台的佣金，而我们会将这些佣金兑换成相应的比特币奖励给您。<a  href="/cases/exin-earn">更多内容</a>' },
      ...
      { title: '机器人托管服务 - 我信', filename: 'ohmy', img: 'exchange.png', date: '2020/05/13', info: '我信 https://ohmy.xin 是基于 Mixin Messenger 建立的托管 Mixin 机器人的 SaaS 服务平台。通过我信平台，用户可以非常容易地上线一个具备各种功能的标准化 Mixin 机器人。 <a href="/cases/ohmy">更多内容</a>' },
    ]
  },
  documentation: [
    {

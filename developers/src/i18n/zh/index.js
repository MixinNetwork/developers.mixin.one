export default {
  ...
  security: {
    ...
    allowed_ips_desc: '只有来自这些地址的请求会被接受。留空表示允许任意 IP 地址访问。',
    allowed_ips_placeholder: '203.0.113.10\n203.0.113.0/24',
    allowed_ips_hint: '支持单个 IPv4 地址和 CIDR 网段，最多 64 条。',
    resource_patterns: '资源规则',
    resource_patterns_desc: '应用只能访问匹配这些规则的资源 URL。留空表示移除限制。',
    resource_patterns_placeholder: 'https://mixin.one/codes/*\nhttps://mixin.one/users/*',
    resource_patterns_hint: '最多 64 条规则，每行填写一个 URL 规则。',
    entry_count: '共 {count} / 64 条',
    max_entries_error: '每项最多填写 64 条。',
  },
  wallet: {
    title: '钱包',
  ...
  secret: {
    ...
    key_registered_content: '当前应用已注册钱包，<span class="warning">Spend Key 无法再次获取，请妥善保管！</span>',
    key_btn: '注册钱包',
    key_question: '确认注册？',
    key_confirm: '我确认已妥善保存 Spend Private Key。',
    qrcode_title: 'Code URL',
    qrcode_content: '显示或重置此应用的 code_url。',
    qrcode_btn1: '显示',
    qrcode_btn2: '重置',
    rotate_qrcode_question: '确认重置 code_url？',
    des: '服务器和浏览器都不会保存这些敏感信息。如果丢失，你可以重新生成。',
  },
  billing: {
    title: '账单',
    cc_title: '充值和花费统计',
    cc_content: '充值跟消费只针对这个机器人，充值是机器人的充值总金额。花费分为两部分，分别是资源(目前主要是链上充值)和子用户创建 <br /><br /> 子帐号：该应用下所有的子帐号花费 <br /><br /> 资源：该应用下所有的充值花费 <br /><br /> 注意：充值后会过几秒钟到帐',
    credit: '充值总计',
    cost: '花费总计',
    users: '子帐号花费:',
    resources: '资源花费:',
  ...
  message: {
    ...
    errors: {
      ...
      20113: '无效的电话验证码。',
      20117: '余额不足。',
      20123: '请购买更多应用或从 Mixin 开发者控制台支付您的应用账单。',
      20119: 'PIN 码不正确。',
      20120: '转账金额太小。',
      ...
      clip_img: '请检查图片文件...',
      pin: '请输入有效的 PIN。',
      mixin_id: '请输入有效的 Mixin ID 或主网地址。',
      copy: '复制失败。',
      reset: '正在重置，请稍候...',
      overtime: '请求失败，请检查网络。',
      unknown: '未知错误。',

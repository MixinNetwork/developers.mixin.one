export default {
  ...
  cases: {
    ...
    route: "用户案例",
    list: [
      { title: 'Blockin 钱包', info: '特征:<br />多币种：BTC，ETH，USDT Omni，USDT ERC20，BSV，DCR，DOGE，BCH，RVN，VCash，ZEC，DASH，LTC当前可用。<br />将会继续支持更多货币。<br />安全性：多重安全性验证可确保资产安全。<br />方便和用户友好：高效的交易，公告和资产变更的实时通知可改善用户体验。<a  href="/cases/0">更多.</a>' },
      { title: 'F1EX 交易所', info: 'F1EX 是 Fox.ONE 的独立交换产品，具有较低的令牌发行成本，高性能，丰富的管理仪表板，多链支持和出色的生态系统。<br /><br />F1EX 专注于安全性和用户体验。 我们在安全机制和易于使用的界面之间取得平衡，从而为所有用户提供最佳功能。<a  href="/cases/1">更多.</a>' },
      { title: 'ETF 投资 - BOX', info: 'F1EX 是 Fox.ONE 的独立交换产品，具有较低的令牌发行成本，高性能，丰富的管理仪表板，多链支持和出色的生态系统。<br /><br />F1EX 专注于安全性和用户体验。 我们在安全机制和易于使用的界面之间取得平衡，从而为所有用户提供最佳功能。<a  href="/cases/2">更多.</a>' },
      { title: '多重签名', info: 'F1EX 是 Fox.ONE 的独立交换产品，具有较低的令牌发行成本，高性能，丰富的管理仪表板，多链支持和出色的生态系统。<br /><br />F1EX 专注于安全性和用户体验。 我们在安全机制和易于使用的界面之间取得平衡，从而为所有用户提供最佳功能。<a  href="/cases/3">更多.</a>' },
      { title: 'ExinLocal，全球的点对点市场', info: 'F1EX 是 Fox.ONE 的独立交换产品，具有较低的令牌发行成本，高性能，丰富的管理仪表板，多链支持和出色的生态系统。<br /><br />F1EX 专注于安全性和用户体验。 我们在安全机制和易于使用的界面之间取得平衡，从而为所有用户提供最佳功能。<a  href="/cases/4">更多.</a>' },
      { title: '商家接受加密货币', info: 'F1EX 是 Fox.ONE 的独立交换产品，具有较低的令牌发行成本，高性能，丰富的管理仪表板，多链支持和出色的生态系统。<br /><br />F1EX 专注于安全性和用户体验。 我们在安全机制和易于使用的界面之间取得平衡，从而为所有用户提供最佳功能。<a  href="/cases/5">更多.</a>' },
      { title: '即时加密信用额度', info: 'F1EX 是 Fox.ONE 的独立交换产品，具有较低的令牌发行成本，高性能，丰富的管理仪表板，多链支持和出色的生态系统。<br /><br />F1EX 专注于安全性和用户体验。 我们在安全机制和易于使用的界面之间取得平衡，从而为所有用户提供最佳功能。<a  href="/cases/6">更多.</a>' },
    ]
  },
